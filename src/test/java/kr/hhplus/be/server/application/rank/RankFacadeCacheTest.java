...
class RankFacadeCacheTest extends IntegrationTestSupport {
    ...
    @BeforeEach
    void setUp() {
        product1 = Product.create("상품명1", 1_000L, 100, ProductStatus.SELLING);
        product2 = Product.create("상품명2", 2_000L, 100, ProductStatus.SELLING);
        product3 = Product.create("상품명3", 3_000L, 100, ProductStatus.STOP_SELLING);
